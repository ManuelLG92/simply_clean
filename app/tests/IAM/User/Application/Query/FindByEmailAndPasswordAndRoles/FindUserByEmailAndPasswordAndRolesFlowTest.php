...
use App\IAM\User\Application\Query\FindByEmailPasswordAndRoles\FindUserByCriteriaAndPasswordUseCase;
use App\IAM\User\Application\Query\FindByEmailPasswordAndRoles\FindUserByEmailPasswordAndRolesQueryHandler;
...
final class FindUserByEmailAndPasswordAndRolesFlowTest extends MockeryTestCase
{
    ...
    public function it_should_find_user_by_email_password_and_role(): void
    {
        ...
        $handler = new FindUserByEmailPasswordAndRolesQueryHandler($useCase);
